...
compound_summary <- compound_summary %>% filter(n_total > 2 & n_select > 1 & n_accession > 1)
...
#now i use the selectivity check below
# cmpdstokeep <- activities_collected2 %>%
...
compound_summary <- compound_summary %>% filter(n_total > 4 & n_select > 3 & n_accession > 3)
